...
type stubAuthService struct {
	registerFn func(context.Context, service.RegisterInput) (*service.AuthResult, error)
	loginFn    func(context.Context, service.LoginInput) (*service.AuthResult, error)

	gotLogin service.LoginInput
}

var _ service.AuthService = (*stubAuthService)(nil)

func (s *stubAuthService) Register(ctx context.Context, in service.RegisterInput) (*service.AuthResult, error) {
	if s.registerFn != nil {
		return s.registerFn(ctx, in)
	}
	return nil, apperror.Internal(nil)
}

func (s *stubAuthService) Login(ctx context.Context, in service.LoginInput) (*service.AuthResult, error) {
	s.gotLogin = in
	if s.loginFn != nil {
...
func (s *stubAuthService) Refresh(context.Context, string) (*service.AuthResult, error) {
	return nil, apperror.Unauthorized("")
}
func (s *stubAuthService) Logout(context.Context, service.LogoutInput) error { return nil }
func (s *stubAuthService) LogoutAll(context.Context, uuid.UUID) error        { return nil }
func (s *stubAuthService) ChangePassword(context.Context, uuid.UUID, string, string) (*service.AuthResult, error) {
	return nil, apperror.Unauthorized("")
}
...
func newTestApp(t *testing.T, svc service.AuthService) *fiber.App {
	t.Helper()
...
func TestLogin_InvalidCredentialsReturnsErrorEnvelope(t *testing.T) {
	...
	require.Equal(t, string(apperror.CodeUnauthorized), body["code"])
...
func TestRegister_ConflictIsPropagated(t *testing.T) {
	...
	require.Equal(t, string(apperror.CodeConflict), body["code"])
}
