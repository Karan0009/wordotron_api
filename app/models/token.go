...
// EmailVerificationToken is the domain view of a single-use email
// verification token. Only the hash is ever persisted; the plaintext exists
// just long enough to be emailed.
